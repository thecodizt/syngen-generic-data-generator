...
class DynamicHomogenous:
    ...
    def input():
        ...
        return num_nodes, node_lower_range, node_upper_range, num_records, num_prop, node_feature_names, num_edge_features, edge_density, edge_feature_names, new_edge_likelihood, delete_edge_likelihood, edge_determination, noise, num_control_points, edge_weight_lower, edge_weight_upper
    ...
    def generate_node_data(num_records, num_nodes, num_prop, num_control_points, noise, features=None, node_lower_range = 0, node_upper_range=1):
        merged_data = generate_n_node_flat_data_in_range(
            ...
            lower_num_properties=num_prop, 
            upper_num_properties=num_prop, 
            noise=noise, 
            features=features,
